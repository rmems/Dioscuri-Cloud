...
- Teardown evidence must be linkable: provider console link showing resource deleted, CLI output snippet confirming deletion, audit log link, or screenshot link.
