...
| IBM Cloud | Cloud credit | 200 | TBD | watsonx, research-agent prototypes, synthetic data pipeline, object storage evaluation | Default spend cap: $20/experiment until exact expiration and quotas are verified | watsonx free trial activated; avoid business-email-gated services unless access is confirmed |
| Oracle Cloud | Free trial | 300 | TBD | Persistent services, MCP hosting, telemetry ingestion, object storage, vector/RAG backend | Default spend cap: $20/experiment; retained resources require monthly cost and review date | Record region, quotas, and free-tier eligibility before creating resources |
